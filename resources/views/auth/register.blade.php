        ...
        <div class="w-full">
            <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                ...
                <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST"
                    ...
                    <div class="flex flex-wrap">
                        <label for="RegNo" class="block text-gray-700 text-sm font-bold mb-2 sm:mb-4">
                    ...
                    <div class="flex flex-wrap">
                        <label for="Programme" class="block text-gray-700 text-sm font-bold mb-2 sm:mb-4">
                            {{ __('Programme') }}:
                        </label>
                    ...
                    <div class="flex flex-wrap">
                        ...
                        <p class="w-full text-xs text-center text-gray-700 my-6 sm:text-sm sm:my-8">
                            ...
                            <a class="text-blue-500 hover:text-blue-700 no-underline hover:underline" href="{{ route('user.login') }}">
                                {{ __('Login') }}
                            </a>
                        </p>
                    </div>
