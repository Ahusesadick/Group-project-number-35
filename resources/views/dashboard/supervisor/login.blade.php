            ...
            <div class="w-full">
                <section class="flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                    ...
                    <header class="text-center font-semibold bg-gray-200 text-gray-700 py-5 px-6 sm:py-6 sm:px-8 sm:rounded-t-md">
                        {{ __('Host Supervisor Login') }}
                    </header>
    
                    <form class="w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST" action="{{ route('supervisor.check') }}">
                   ...
                   @endif
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <p class="w-full text-xs text-center text-gray-700 my-6 sm:text-sm sm:my-8">
                                ...
                                <a class="text-blue-500 hover:text-blue-700 no-underline hover:underline" href="{{ route('supervisor.register') }}">
                                    {{ __('Register') }}
                                </a>
                            </p>
                            @endif
