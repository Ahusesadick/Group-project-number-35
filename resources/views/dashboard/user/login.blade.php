...
<body class=" bg-no-repeat bg-cover" style="background-image: url( {{ asset('images/8.jpg') }})">
        ...
        <div class="flex">
            <div class="w-full">
                <section style="background-image: url( {{ asset('images/2.jpg') }})" class="bg-no-repeat bg-cover flex flex-col break-words bg-white sm:border-1 sm:rounded-md sm:shadow-sm sm:shadow-lg">
                    ...
                    <form class=" w-full px-6 space-y-6 sm:px-10 sm:space-y-8" method="POST" action="{{ route('user.check') }}">
                        @csrf
                        ...
                        <div class="flex flex-wrap">
                            ...
                            <p class="w-full text-xs text-center text-white my-6 sm:text-sm sm:my-8">
                                ...
                                <a class="text-white hover:text-blue-700 no-underline hover:underline" href="{{ route('user.register') }}">
                                    {{ __('Register') }}
                                </a>
                            </p>
                            @endif
