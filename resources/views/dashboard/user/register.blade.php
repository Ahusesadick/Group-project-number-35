            ...
            <div class="w-full">
               ...
               @endif
                    ...
                    <div class="grid gap-9 grid-cols-2">
                        ...
                        <div class="flex flex-wrap">
                            <label for="RegNo" class="block text-white text-sm font-bold mb-2 sm:mb-4">
                                {{ __('Registration Number') }}:
                            </label>
    
                            <input id="RegNo" type="text"
                                class="form-input w-full @error('RegNo') border-red-500 @enderror" name="RegNo"
                        ...
                        <div class="flex flex-wrap">
                            <label for="Programme" class="block text-white text-sm font-bold mb-2 sm:mb-4">
                                {{ __('Programme') }}:
                            </label>
    
                            <input id="Programme" type="text"
                                class="form-input w-full @error('Programme') border-red-500 @enderror" name="Programme"
                                value="{{ old('Programme') }}" required autocomplete="Programme">
                        ...
                        <div class="flex flex-wrap">
                            <label for="Orgname" class="block text-white text-sm font-bold mb-2 sm:mb-4">
                        ...
                        <div class="flex flex-wrap">
                            <label for="Orglocation" class="block text-white text-sm font-bold mb-2 sm:mb-4">
